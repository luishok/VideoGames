...
TEXTURES = {
    ...
    "chest": pygame.image.load(BASE_DIR / "assets" / "graphics" / "Chest 1.png"),
    "chest-open": pygame.image.load(BASE_DIR / "assets" / "graphics" / "Chest 2.png"),
    "fire": pygame.image.load(BASE_DIR / "assets" / "graphics" / "Fire.png"),
